...
export function useStorePlugin() {
  ...
  const matchShortcut = useCallback(function (e: Shortcut, shortcut: Shortcut) {
    return (
...
export type StorePlugin = ReturnType<typeof useStorePlugin>;

export const StoreContext = createContext<StorePlugin | null>(null);
